package com.yourid.movieshowcase.core.model.database.models

import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.PrimaryKey
import androidx.room.TypeConverters
import com.yourid.movieshowcase.core.model.database.converters.CompaniesConverter
import com.yourid.movieshowcase.core.model.database.converters.CountriesConverter
import com.yourid.movieshowcase.core.model.database.converters.GenresConverter
import com.yourid.movieshowcase.core.model.database.converters.LanguagesConverter
...
data class MovieDetailsModel(
    ...
    @ColumnInfo(name = "production_companies") val productionCompanies: List<ProductionCompaniesItemModel>,
    @ColumnInfo(name = "production_countries") val productionCountries: List<ProductionCountriesItemModel>,
